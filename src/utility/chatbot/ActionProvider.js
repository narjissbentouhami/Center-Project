...
const intro = 'Select one to leave a message'
const experience = 'Voilà ...'
const projects = 'Voilà laisser un message '
const skills =
...
class ActionProvider {
  ...
  handleGoodMoodFinally() {
    const message = this.createChatBotMessage(`Glad you're happy! Let me do a quick self intro: ${intro}`, {
      widget: 'personalOptions'
    })
    this.updateChatbotState(message)
  }
