...
const MainNonProgList = (props: any) => {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:8000/entretiens/attente').then(response => {
      setMaintenanceData2(response.data.reverse())
    })
  }, [])
          ...
          <Fragment key={'encours' + index}>
            ...
            >
              ...
              >
                ...
                >
                  <Icon icon={open['encours' + index] ? 'mdi:chevron-up' : 'mdi:chevron-down'} />
                </ListItemIcon>
                <ListItemText
                  sx={{
                    '.MuiTypography-root': {
...
export default MainNonProgList
