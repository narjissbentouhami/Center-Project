...
const ApexAreaChart = (values: any) => {
  ...
  const fetchData = async () => {
    try {
      ...
      // const updatedSeries = responses.map((response, index) => {
      //   return {
      //     name: ids[index],
      //     data: response.data
      //   }
      ...
      const labelseries = values.values.map((item: any) => {
        return item.date
      })
      // const series1 = updatedSeries[1].data.map((item: any) => {
      //   return item.Value
      // })
      // const series2 = updatedSeries[2].data.map((item: any) => {
      //   return item.Value
      // })
