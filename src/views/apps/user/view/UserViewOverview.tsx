...
import MaintenanceTable from 'src/views/dashboards/crm/maintenance/maintenanceTable'
import MaintenanceTablee from './MaintenanceTablee'
...
const UserViewOverview = ({ invoiceData ,globalModel}: Props) => {
  return (
    <Grid container spacing={6}>
      <Grid item xs={12}>
        <MaintenanceTablee globalModel={globalModel} />
      </Grid>
      <Grid item xs={12}>
        {/* <Card>
