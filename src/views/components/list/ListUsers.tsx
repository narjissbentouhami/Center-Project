...
const ListUsers = () => {
  return (
    <StyledList disablePadding>
      <ListItem>
        <ListItemAvatar>
          <Avatar src='/images/icons/marker.png' alt='Caroline Black' />
        </ListItemAvatar>
        <div>
          <ListItemText primary='Casablanca' />
          <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
            ...
            <Typography variant='caption' sx={{ color: 'text.disabled' }}>
              Dernière visite il y'a 13 minutes
            </Typography>
          </Box>
        </div>
      ...
      <ListItem>
        <ListItemAvatar>
          <Avatar src='/images/icons/marker.png' alt='Alfred Copeland' />
        </ListItemAvatar>
        <div>
          <ListItemText primary='Marrakech' />
          <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
      ...
      <ListItem>
        <ListItemAvatar>
          <Avatar src='/images/icons/marker.png' alt='Celia Schneider' />
        </ListItemAvatar>
        <div>
          <ListItemText primary='Oujda' />
          <Box sx={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap' }}>
