...
import { Avatar, IconButton, Typography, Box, ButtonBase, Button } from '@mui/material'
...
function LinksBar() {
  ...
  return (
    <>
      <Box component={ButtonBase} onClick={() => setPopoverOpen(!popoverOpen)} ref={avatarRef}>
      ...
      >
        <Box flex flexDirection='column'>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
            <EmailIcon />
            <Typography variant='span' sx={{ marginLeft: '8px', marginTop: '5px' }}>
